...
- [x] Task: Enable Tailwind `class` dark mode strategy
...
- [x] Task: Add FOUC prevention script to Dashboard & Task pages
...
- [x] Task: Create localStorage theme utility helper
...
- [x] Task: Add theme toggle button to header (dashboard.html & task.html)
...
- [x] Task: Wire toggle to Alpine.js state
...
- [x] Task: Apply dark mode styles to Dashboard (dashboard.html)
...
- [x] Task: Apply dark mode styles to Task Editor (task.html)
...
- [x] Task: Ensure Login & Register pages remain light-only (no changes)
